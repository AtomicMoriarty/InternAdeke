        ...
        <>
          ...
          >
            ...
            <Cartao titulo="Carga por pessoa" sub="Quantas demandas cada um tem">
              {carga.length === 0 ? (
                <Nota>
                  Nenhum item tem responsável atribuído. Abra um card e use <strong>Membros</strong>{" "}
                  para atribuir.
                </Nota>
              ) : (
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
                  <thead>
                    ...
                    >
                      ...
                      <th style={th} title="Prazo vencido">
                        Atraso
                      </th>
                      <th style={th} title="Sem movimento há 7 dias ou mais">
                        Parado
                      </th>
                      <th style={th} title="Média de dias desde a data de início">
                        Média
                      </th>
                    </tr>
                  </thead>
                      ...
                      return (
                        <tr key={c.userId} style={{ borderTop: "1px solid #F1F5F9" }}>
                          ...
                          <td
                            style={{
                              ...td,
                              color: c.vencidos ? "#DC2626" : "#CBD5E1",
                              fontWeight: c.vencidos ? 800 : 500,
                            }}
                          >
                            {c.vencidos}
                          </td>
                          <td
                            style={{
                              ...td,
                              color: c.parados7 ? "#B45309" : "#CBD5E1",
                              fontWeight: c.parados7 ? 800 : 500,
                            }}
                          >
                            {c.parados7}
                          </td>
                        ...
                        >
                          ...
                          <span style={{ fontSize: 11, color: "#64748B" }}>
                            ...
                            <span style={{ color: "#CBD5E1" }}>
                              · {t.amostras} {t.amostras === 1 ? "item" : "itens"}
                            </span>
                          </span>
                        </div>
                        <div
                  ...
                  {parados.slice(0, 30).map(({ item, dias }) => (
                    <div
                      ...
                      style={{
                        ...
                        gap: 9,
                        padding: "7px 9px",
                        background: dias >= 14 ? "#FEF2F2" : "#FFFBEB",
                        borderRadius: 8,
            ...
            >
              {atividade.length === 0 ? (
                <Nota>
                  ...
                  {periodoDias ? `nos últimos ${periodoDias} dias` : "registrada"}. Mudanças de
                  status e comentários aparecem aqui.
                </Nota>
              ) : (
                <div
                  style={{
...
function Nota({ children }) {
  return (
    <p style={{ fontSize: 11.5, color: "#94A3B8", lineHeight: 1.6, padding: "6px 0" }}>
      {children}
    </p>
  );
}
