  ...
  return (
    <div style={{
      ...
      <button onClick={onClick} style={{
        display: "flex", gap: 10, flex: 1, minWidth: 0, background: "none", border: "none",
      ...
      {!n.lida && (
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 4, flexShrink: 0 }}>
          ...
          <button
            ...
            style={{ background: "transparent", border: "none", cursor: "pointer", color: "#0DD3C5", padding: 4, borderRadius: 4, display: "flex" }}
          >
            <Check size={14} />
          </button>
        </div>
