...
export const CHECKLIST_POR_DEMANDA: Record<string, string[]> = {
  ...
  "Resposta a exigência": [
    "Ler a exigência publicada na RPI",
  ...
  Renovação: [
    "Conferir prazo de vigência",
    "Emitir GRU de renovação",
    "Pagamento",
    "Protocolo",
    "Confirmar deferimento",
  ],
  "Alteração contratual": [
    "Levantar documentos societários",
    "Minutar alteração",
    "Colher assinaturas",
    "Protocolar na Junta",
  ...
  "Constituição de empresa": [
    ...
    "Definir objeto social e capital",
    "Minutar contrato social",
    "Colher assinaturas",
    "Registro na Junta",
    "CNPJ",
  ...
  "Mapeamento de Dados": [
    ...
    "Preencher planilha de mapeamento",
    "Desenhar fluxo de tratamento",
...
export function allowedModulesFor(
  profile: { allowed_modules?: unknown } | null | undefined,
): string[] {
